...
app.controller('myCtrl', function($http, $scope) {
			...
			_.numero_operacion = $_GET['numero_operacion'];
			...
			_.quitar = function () {
										if (_.capital_inicial <= 20000){
												_.quita_descripcion = 'Deuda menor a $20000. ';
												if(_.quitas == '1'){
												_.quita_descripcion += '50% de descuento.';
												_.quita_final = _.capital_inicial - (_.capital_inicial * (50/100));
												}else{
													if(_.quitas == '12'){
														_.quita_descripcion += '35% de descuento.';
														_.quita_final = _.capital_inicial - (_.capital_inicial * (35/100));
													}else{
														if(_.quitas == '36'){
															_.quita_descripcion = 'No esta habilitado este tipo de pago.';
															_.quita_final = 0;
														}
													}
												}
										...
										if (_.total > 20000){
												_.quita_descripcion = 'Deuda mayor a $20000. ';
												if(_.quitas == '1'){
												_.quita_descripcion += '35% de descuento.';
												_.quita_final = _.capital_inicial - (_.capital_inicial * (35/100));
												}else{
													if(_.quitas == '12'){
														_.quita_descripcion = 'No hay quitas para este tipo de pago.';
														_.quita_final = _.capital_inicial;
													}else{
														if(_.quitas == '36'){
															_.quita_descripcion += 'No hay quita.';
															_.quita_final = _.capital_inicial;
														}
													}
												}
			...
			$http.post('php/datos.php', datos)
  			...
  			_.plazo=1; _.porcentaje='30%'; _.quitas='1'; _.fecha_anticipo = new Date(); _.cambio_primer_cuota(); _.calcular_cuotas; _.quitar();
