  ...
  <tbody ng-if="volver==1" infinite-scroll="bajar()" infinite-scroll-container='".tablon"' infinite-scroll-distance="1" infinite-scroll-disabled="!tabla || limite>=tabla.length">
    ...
    <div class="input-group pull-right" style="width:50%">
      <span class="input-group-addon dropup" style="border-radius:0px;height:24px;font-size:11px;border:1px solid #ccc;">
        <span class="dropdown-toggle" data-toggle="dropdown" style="font-size:11px;width:100%;height:100%;">Asignar responsalbe &#x25B4;</span>
        <ul class="dropdown-menu dropdown-menu-right dont-go" style="border-radius:0px;padding:20px;padding-top:70px">
          <li>
            ...
            <div class="input-group" style="height:20px;">
              <span class="input-group-addon">Responsable</span><select style="font-size:9px;" class="form-control" ng-options="responsable as responsable.user for responsable in usuarios"  ng-model="asignar.responsable" style="font-size:9px;"></select>
            </div>
              <span class="form-control btn btn-primary" style="font-size:10px;" ng-click="accion.asignar()">Agregar</span>          </div>
          </li>
        </ul>
      </span>
      <span class="input-group-addon btn" style="border-radius:0px;height:24px;font-size:11px;border:1px solid #ccc;">
        Retirar responsable
      </span>
