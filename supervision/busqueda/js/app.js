...
.controller('gestion', function($scope, sharedVars, socket, $timeout, $http){
		...
		_.registrar = function (){
			...
			$http.post('php/registrar-gestion.php', datos).then(function (res){
...
.controller('deudor', function($scope, sharedVars, $http) {
		...
		_.input=sharedVars.input;
		_.deudor='Deudor';
		_.ver_gestion=function(){abrirVentana('gestion-'+_.data.deudor.documento, '/general/gestion-telefonica/manual/llamadas/?documento='+_.data.deudor.documento)}
