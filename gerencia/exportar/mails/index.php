...
<div class="header buscador" style="height:25px;width:900px;margin-left:-2px;border-bottom:0px;">
  ...
  <span data-toggle="tooltip" title="Buscar" data-placement="bottom" ng-click="buscar.complejo()" style="padding:2px;margin-right:-2px;"><img src="/.img/search.png" style="width:13px;height:13px;margin-left:2px;margin-top:-3px;"></span>
  ...
  <span style="padding:2px;margin-right:-2px;border-left:1px solid #ddd;"  data-toggle="tooltip" title="Fecha de solicitud" data-placement="bottom"><img src="/.img/agenda.png" style="width:15px;height:13px;margin-left:2px;margin-top:-3px;"></span>
  <span style="padding:2px;margin-right:-2px;">
  <span class="dropdown">
        <span class="dropdown-toggle" data-toggle="dropdown">Solicitud &#x25BE;</span>
        <ul class="dropdown-menu noshadow dont-go inputs" style="position:absolute;left:-20px;margin-top:2px;">
            ...
            <span class="button" style="margin:5px;">
              ...
              <span style="border-left:1px solid #ddd;padding:2px 5px 2px 5px;margin-right:-2px;"><input type="date"  ng-model="complejo.fecha1" style="width:95px;font-size:10px;background:none;"></span>
            </span>  
          </div>
            <div style="margin-top:5px;">
            <span class="button"  style="margin:5px;">
              <span style="padding:2px;color:#aaa;">Hasta</span>
              <span style="border-left:1px solid #ddd;padding:2px 5px 2px 5px;margin-right:-2px;"><input type="date"  ng-model="complejo.fecha2"  style="width:97px;font-size:10px;background:none;"></span>
            </span>  
          </div>
   </ul>
      </span>
    </span>
  <span data-toggle="tooltip" title="Limpiar" data-placement="bottom" ng-click="complejo={}" style="border-left:1px solid #ddd;padding:2px;margin-right:-2px;"><img src="/.img/borrar.png" style="width:13px;height:13px;margin-left:2px;margin-top:-3px;"></span>
  </span>
</span>
</div>

  <div style="top:65px;position:absolute;width:100%;overflow-x:scroll;height:300px;" class="tablon">
  <div style="width:800px;">
  <table class="with-ellipsis"  ng-init="limite=20;orden='documento';" style="z-index:1;position:absolute;width:800px;" >
    <thead>
  ...
  <table class="with-ellipsis" style="position:absolute;z-index:0;width:800px;">
      <thead>
      <tr>
        <td ng-repeat="s in [1,2,3,4,5,6,7,8]" style="width:100px;"></td>
      </tr>
    </thead>
      <tbody>
...
<table ng-init="limite=20;orden='documento';" height="100px">
  ...
  -->
    ...
    <span class="dropup">
        ...
        </span>      <ul class="noshadow dropdown-menu dropdown-menu-right dont-go" style="margin-top:-10px;position:absolute;left:3px;height:200px;width:250px;border-radius:5px;border-color:#ddd;">
        <li>
...
.controller('filtro', function($scope, $http, $timeout) {
  ...
  _.descargar = function (){
    ...
    exportar(_.tabla, 'enviar_mail.xlsx');
