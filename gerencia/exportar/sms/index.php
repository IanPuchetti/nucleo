...
<div class="header buscador" style="height:25px;width:900px;margin-left:-2px;border-bottom:0px;">
  ...
  <table class="with-ellipsis"  ng-init="limite=20;orden='documento';" style="z-index:1;position:absolute;width:900px;" >
    <thead>
  ...
  <table class="with-ellipsis" style="position:absolute;z-index:0;width:900px;">
      <thead>
      <tr>
        <td ng-repeat="s in [1,2,3,4,5,6,7,8,9]" style="width:100px;"></td>
      </tr>
    </thead>
      <tbody>
