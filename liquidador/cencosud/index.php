...
<body style="background:#eee;" ng-app="myApp">
	...
	<h2 class="lead">Liquidación</h2>
      ...
      <div class="borde-inferior">Gestión: {{numero_gestion}}°</div>
  		<div class="borde-inferior">Fecha de actualización: <input type="date" ng-model="fecha_actualizacion" ng-change="reload();fecha_anticipo=fecha_actualizacion;"></div>
