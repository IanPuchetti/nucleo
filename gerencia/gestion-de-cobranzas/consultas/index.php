    ...
    <span class="dropdown" >
      ...
      <ul class="dropdown-menu dropdown-menu-right dont-go" style="border-radius:0px;margin-top:9px;height:500px;overflow-y:auto;width:200px;">
        <li>
          ...
          <div style="padding:5px 0px 0px 5px;border-bottom:1px #ddd solid;"><input type="checkbox" ng-model="campo.gestion.telefono" ng-init="campo.gestion.telefono=true" class="css-checkbox" id="check8"><label class="css-label" for="check8" style="font-size:12px;font-weight:normal;">Telefono</label></div>
          <div style="padding:5px 0px 0px 5px;border-bottom:1px #ddd solid;"><input type="checkbox" ng-model="campo.gestion.calificacion" ng-init="campo.gestion.calificacion=true" class="css-checkbox" id="check16"><label class="css-label" for="check16" style="font-size:12px;font-weight:normal;">Calificacion telefono</label></div>
          <div style="padding:5px 0px 0px 5px;border-bottom:1px #ddd solid;"><input type="checkbox" ng-model="campo.gestion.comentario" ng-init="campo.gestion.comentario=true" class="css-checkbox" id="check9"><label class="css-label" for="check9" style="font-size:12px;font-weight:normal;">Descripcion</label></div>
          <div style="padding:5px 0px 0px 5px;border-bottom:1px #ddd solid;"><input type="checkbox" ng-model="campo.gestion.fecha" ng-init="campo.gestion.fecha=true" class="css-checkbox" id="check10"><label class="css-label" for="check10" style="font-size:12px;font-weight:normal;">Fecha</label></div>
          <div style="padding:5px 0px 0px 5px;border-bottom:1px #ddd solid;"><input type="checkbox" ng-model="campo.gestion.hora" ng-init="campo.gestion.hora=true" class="css-checkbox" id="check11"><label class="css-label" for="check11" style="font-size:12px;font-weight:normal;">Hora</label></div>
          <div style="padding:5px 0px 0px 5px;border-bottom:1px #ddd solid;"><input type="checkbox" ng-model="campo.gestion.sub_estado" ng-init="campo.gestion.sub_estado=true" class="css-checkbox" id="check12"><label class="css-label" for="check12" style="font-size:12px;font-weight:normal;">Sub estado</label></div>
          <div style="padding:5px 0px 0px 5px;border-bottom:1px #ddd solid;"><input type="checkbox" ng-model="campo.gestion.tiempo" ng-init="campo.gestion.tiempo=true" class="css-checkbox" id="check13"><label class="css-label" for="check13" style="font-size:12px;font-weight:normal;">Tiempo</label></div>
          <div style="padding:5px 0px 0px 5px;border-bottom:1px #ddd solid;"><input type="checkbox" ng-model="campo.gestion.operador" ng-init="campo.gestion.operador=true" class="css-checkbox" id="check14"><label class="css-label" for="check14" style="font-size:12px;font-weight:normal;">Operador</label></div>
          <div style="padding:5px 0px 0px 5px;border-bottom:1px #ddd solid;"><input type="checkbox" ng-model="campo.gestion.tipo_gestion" ng-init="campo.gestion.tipo_gestion=true" class="css-checkbox" id="check15"><label class="css-label" for="check15" style="font-size:12px;font-weight:normal;">Tipo de gestion</label></div>
        </li>
      </ul>
    </span>
...
Contactados
      ...
      <span class="btn input-group-addon" style="border-radius:0px;height:24px;font-size:11px;">Operador</span>
      <select class="form-control" placeholder="Nombre del archivo" style="border-radius:0px;border-color:#aaa;height:25px;font-size:10px" ng-model="complejo.operador" ng-options="responsable as responsable.user for responsable in usuarios"><option></option></select>
    </span>
    </span>  
  </div>
  <!--
...
<table ng-init="limite=20;orden='documento';" height="100px">
  ...
  <tbody ng-if="volver==1" infinite-scroll="bajar()" infinite-scroll-container='".tablon"' infinite-scroll-distance="1" infinite-scroll-disabled="!tabla || limite>=tabla.length">
    <tr ng-repeat="(i, fila) in ::tabla  | orderBy: orden" ng-if="i<limite">
      <td ng-repeat="valor in fila" title="{{valor}}" style="width:300px;">{{ valor | limitTo: 20 }}{{valor.length > 20 ? '...' : ''}}</td>
    </tr>
  </tbody>
</table>
    </div>
