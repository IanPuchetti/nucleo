        ...
        <ul class="dropdown-menu dropdown-menu-right dont-go" style="border-radius:0px;padding:20px;padding-top:70px">
          <li>
            ...
            <div class="input-group" style="height:20px;">
              <span class="input-group-addon">Estado</span><select style="font-size:9px;" class="form-control" ng-options="estado as estado.estado for estado in estados"  ng-model="modificar_estado.estado" style="font-size:9px;"></select>
            </div>
