...
<div class="col-md-6">
	...
	<table>
  <tr><td>Banco</td><td><select class="btn-default" id="banco"><option>nulo</option></select></td></tr>
	<tr><td>Nombre</td><td><select class="lista btn-default" id="nombre"><option>nulo</option></select></td></tr>
	<tr><td>Tipo llamado</td><td><select class="lista btn-default" id="tipo_llamado"><option>nulo</option></select></td></tr>
	<tr><td>Fecha</td><td><select class="lista btn-default" id="fecha"><option>nulo</option></select></td></tr>
	<tr><td>Hora</td><td><select class="lista btn-default" id="hora"><option>nulo</option></select></td></tr>
  <tr><td>Descripcion</td><td><select class="lista btn-default" id="descripcion"><option>nulo</option></select></td></tr>
	</table>
...
datos['datos']=JSON.stringify({
            banco:$("#banco").children(":selected").attr("id"),
						nombre: excel[i][$("#nombre").val()],
						tipo_llamado: excel[i][$("#tipo_llamado").val()],
						fecha: transform_fecha(excel[i][$("#fecha").val()]),
						hora: excel[i][$("#hora").val()],
            descripcion: excel[i][$("#descripcion").val()]
						});
			datos['proceso']=i;
