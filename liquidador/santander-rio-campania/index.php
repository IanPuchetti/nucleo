...
<body style="background:#eee;" ng-app="myApp">
	...
	<div class="panel panel-info">
    	...
    	<select class="form-control btn btn-info" ng-model='pagos' ng-change="quitar()">
        <option>1</option>
        <option>2</option>
        </select>
   		</div>
	...
	<div class="panel panel-default">
      ...
      <div class="panel-body" style="text-align:left;font-weight:200;font-size:18px;">
        <div class="input-group">
          ...
          <button class="form-control" ng-init="cuota_cero=0" ng-show="cuota_cero==0" ng-click="cuota_cero=1">No</button>
          <button class="form-control" ng-init="cuota_cero=1" ng-show="cuota_cero==1" ng-click="cuota_cero=0">Si</button>
