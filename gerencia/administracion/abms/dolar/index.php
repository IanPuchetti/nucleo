...
<nav class="navbar navbar-default navbar-static-top">
  <div class="container-fluid">
    ...
    <div class="container" ng-controller="controller">
      <div ng-controller="controller" style="width:100%;max-width:400px;margin:auto;margin-top:25px;">
        <div>
          <div class="input-group">
          <span class="input-group-addon" style="background:#eee">Dolar oficial</span><span class="form-control" style="background:#eee;height:30px;">${{dolar.oficial}}</span>
          </div>
        <div class="input-group">
          <span class="input-group-addon" style="background:#fff">Dolar actual en el sistema</span><span class="input-group-addon" style="background:#fff;border-right:0px;">$</span><input type="number" class="form-control"  style="height:30px;border-left:0px;" step="0.01" ng-model="dolar.actual"><span class="input-group-addon btn btn-default" style="background:#fff" ng-click="modificar()">Modificar</span>
        </div>
      </div>  
    </div>
    <script>
      angular.module('myApp',[])
          ...
          $scope.dolar={};
		      $http.post('http://ws.geeklab.com.ar/dolar/get-dolar-json.php').then(function (res){ $scope.dolar.oficial = res.data.libre;});
          $http.post('php/dolar.php').then(function (res){ $scope.dolar.actual = parseFloat(res.data[0].valor);});
		      $scope.modificar = function (id_banco, liquidador){
			      $http.post('php/modificar.php',{valor : $scope.dolar.actual}).then(function(res){alert(res.data);});
		      };
	      });
    </script>
  </body>
