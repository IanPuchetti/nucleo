...
<div class="form-group">
	...
	<div class="form-group">
      ...
      <button class="btn btn-default form-control" id="pesos" style="font-size:10px;" onclick="cambiar('pesos','dolares')">Deuda en pesos</button><button id="dolares" class="btn btn-default form-control" onclick="cambiar('dolares','pesos')" style="display:none;font-size:10px;" >Deuda en dolares</button>
    </div>
<div class="form-group">
