...
<nav class="navbar  nav2 navbar-default" style="border-bottom:#ddd 1px solid;margin-top:-45px;">
  <div class="navbar-header pull-right" id="myNavbar">
    <span class="dropdown" >
      <span class="dropdown-toggle" type="button" style="border-radius:0px;color:#4574a9;border:0px;padding:10px;cursor:pointer;" data-toggle="dropdown"><span style="font-size:10px;">Campos<span class="caret"></span></span></span>
      <ul class="dropdown-menu dropdown-menu-right dont-go" style="border-radius:0px;margin-top:9px;height:300px;overflow-y:auto;width:200px;">
        <li>
    ...
    <span class="dropdown" style="margin-left:-5px;">
      <span class="dropdown-toggle" type="button" style="border-radius:0px;color:#6a9e60;border-color:#6a9e60;padding:10px;margin-top:10px;" data-toggle="dropdown"><span style="font-size:10px;">Exportar<span class="caret"></span></span></span>
  ...
  <div class="navbar-header pull-left" id="myNavbar" style="margin-top:10px;margin-left:-20px;">
    <span class=" input-group" style="width:100%;">
      ...
      <select style="font-size:9px;" class="form-control" placeholder="Nombre del archivo" style="border-radius:0px;border-color:#aaa;height:25px;font-size:10px" ng-model="complejo.banco" ng-options="banco as banco.banco for banco in bancos"><option></option></select>
      <span class="input-group-addon dropdown" style="border-radius:0px;height:24px;font-size:11px;">
  ...
  <div class="navbar-header pull-left" id="myNavbar" style="margin-left:-20px;">
    <span class=" input-group" style="width:100%;">
      ...
      <select style="font-size:9px;" class="form-control" placeholder="Nombre del archivo" style="border-radius:0px;border-color:#aaa;height:25px;font-size:10px" ng-model="complejo.estado" ng-options="estado as estado.estado for estado in estados" ><option></option></select>
      <span class="input-group-addon dropdown" style="border-radius:0px;height:24px;font-size:11px;">
      ...
      <select style="font-size:9px;" class="form-control" placeholder="Nombre del archivo" style="border-radius:0px;border-color:#aaa;height:25px;font-size:10px" ng-model="complejo.sub_estado" ng-options="sub_estado as sub_estado.sub_estado for sub_estado in sub_estados" ><option></option></select>
      <span class="input-group-addon dropdown" style="border-radius:0px;height:24px;font-size:11px;">
...
<table ng-init="limite=20;orden='documento';" height="100px">
  ...
  <tbody ng-if="volver==1" infinite-scroll="bajar()" infinite-scroll-container='".tablon"' infinite-scroll-distance="1" infinite-scroll-disabled="!tabla || limite>=tabla.length">
    ...
    <div class="input-group" style=""><span class="input-group-addon">Cantidad de resultados</span><span class="form-control" style="font-size:10px;">{{tabla.length}}</span><span class="input-group-addon">Total en pesos</span><span class="form-control" style="font-size:10px;">${{total_pesos | number:2}}</span></div>
    <div class="input-group pull-left" style="width:100px;">
      <span class="input-group-addon btn btn-success" onclick="$('#xlsx').click()" style="border-radius:0px;height:24px;font-size:11px;border:1px solid green;color:white;background:green;">
       Importar xlsx        
      </span>
      <span class="input-group-addon btn btn-default" ng-click="leer_excel()" style="background:white;">&#x25B4;</span>
    ...
    <div class="input-group pull-right" style="width:50%">
      <span class="input-group-addon dropup" style="border-radius:0px;height:24px;font-size:11px;border:1px solid #ccc;">
        <span class="dropdown-toggle" data-toggle="dropdown" style="font-size:11px;width:100%;height:100%;">Modificar estado &#x25B4;</span>
        <ul class="dropdown-menu dropdown-menu-right dont-go" style="border-radius:0px;padding:20px;padding-top:70px">
          <li>
            ...
            <div class="input-group" style="height:20px;">
              <span class="input-group-addon">Estado</span><select style="font-size:9px;" class="form-control" ng-options="estado as estado.estado for estaod in estados"  ng-model="modificar_estado.estado" style="font-size:9px;"></select>
            </div>
              <input class="form-control" placeholder="Motivo...">
              <span class="form-control btn btn-primary" style="font-size:10px;" ng-click="modificar.estado.()">Modificar</span>          </div>
          </li>
        </ul>
      </span>
      <span class="input-group-addon dropup" style="border-radius:0px;height:24px;font-size:11px;border:1px solid #ccc;">
        <span class="dropdown-toggle" data-toggle="dropdown" style="font-size:11px;width:100%;height:100%;">Modificar sub estado &#x25B4;</span>
        <ul class="dropdown-menu dropdown-menu-right dont-go" style="border-radius:0px;padding:20px;padding-top:70px">
          <li>
            <div style="margin-top:-60.5px;">
            <div class="input-group" style="height:20px;">
              <span class="input-group-addon">Sub estado</span><select style="font-size:9px;" class="form-control" ng-options="sub_estado as sub_estado.sub_estado for sub_estado in sub_estados"  ng-model="agregar.campania" style="font-size:9px;"></select>
            </div>
            <input class="form-control" placeholder="Motivo...">
              <span class="form-control btn btn-primary" style="font-size:10px;" ng-click="modificar.sub_estados()">Modificar</span>          </div>
          </li>
        </ul>
      </span>
