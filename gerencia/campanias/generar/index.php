  ...
  <tbody ng-if="volver==1" infinite-scroll="bajar()" infinite-scroll-container='".tablon"' infinite-scroll-distance="1" infinite-scroll-disabled="!tabla || limite>=tabla.length">
    ...
    <div class="input-group pull-right" style="width:50%">
      <span class="input-group-addon dropup" style="border-radius:0px;height:24px;font-size:11px;border:1px solid #ccc;">
        <span class="dropdown-toggle" data-toggle="dropdown" style="font-size:11px;width:100%;height:100%;">Agregar agenda &#x25B4;</span>
        <ul class="dropdown-menu dropdown-menu-right dont-go" style="border-radius:0px;padding:20px;padding-top:75.5px">
          <li>
            ...
            <div class="input-group" style="height:20px;">
              <span class="input-group-addon">Operador</span><select style="font-size:9px;" class="form-control" ng-options="responsable as responsable.user for responsable in usuarios" ng-model="agendar.operador"style="font-size:9px;"></select>
            </div>
            <div class="input-group" style="height:20px;">
              <span class="input-group-addon">Fecha</span><input type="date" style="font-size:9px;" class="form-control" ng-model="agendar.fecha">
            </div>
              <span class="form-control btn btn-primary" style="font-size:10px;" ng-click="accion.agendar()">Agregar</span>          </div>
          </li>
        </ul>
      </span>
      <span class="input-group-addon dropup" style="border-radius:0px;height:24px;font-size:11px;border:1px solid #ccc;">
