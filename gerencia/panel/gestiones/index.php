...
.bloque:hover{
  ...
  <img src="/.img/new-window.png" style="width:20px;position:fixed;left:5px;bottom:5px;cursor:pointer;" onclick="abrirVentana()">
<div class="header">
...
<div style="height:350px;overflow-y:auto;width:770px;margin-left:30px;">
  ...
  .controller("gestiones", function ($scope, $http, $timeout, socket) {
	...
	function abrirVentana() {
                    ...
                    var win = new BrowserWindow({ width: 800, height: 400, frame:false, resizable:false});
                    win.loadURL('http://'+document.URL.split("/")[2]+'/gerencia/panel/gestiones/ventana');  }
