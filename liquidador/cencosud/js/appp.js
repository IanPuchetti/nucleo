...
app.controller('myCtrl', function($http, $scope) {
			...
			_.reload_telefonos = function (){ $http.post('php/telefonos.php', {documento:$_GET['documento']}).then(function(res){
		...
		_.reload_telefonos();
			...
			_.calcular_cuotas = function ()	    {	_.TOTAL_cuota_total=0;
													...
													for(var i=0;i<_.plazo;i++){
														...
														diferencia_dias = tasa * calcularDate(_.fecha_primer_cuota, _.fecha_anticipo) / 365;
			...
			_.quitar = function () {	if(_.a_financiar1){_.a_financiar1 = _.a_financiar1.replace(',','');}
										if (_.quitas == '1'){
												_.quita_descripcion = 'Un solo pago';
												_.quita_final = parseFloat(_.a_financiar1);
										}else{
												if (_.quitas == 'Menor o igual a 12'){
													_.quita_descripcion = '10% de quita | 36% de tasa de interes por refinanciación';
													_.quita_final = parseFloat(_.a_financiar1) - (parseFloat(_.a_financiar1) * (10/100)) ;
												}else{
													if (_.quitas == 'Mas de 12'){
														_.quita_descripcion = '36% de tasa de interes por refinanciación';
													_.quita_final = parseFloat(_.a_financiar1) ;
													}
												}
										}
			...
			_.reload= function (){
  			...
  			_.plazo=0; _.porcentaje=10; _.quitas='1'; _.fecha_anticipo = new Date(); _.cambio_primer_cuota(); _.calcular_cuotas(); _.quitar();
