...
<div class="container" ng-app="myApp" style="position:fixed;left:-100%;"> 
	<div ng-controller="busqueda" style="position:fixed;top:0px;left:0px;">
	<div class="borde-abajo input-group">
        <div class="input-group-addon btn" ng-click="deudor()">Deudor</div>
        <div class="input-group-addon btn" ng-click="productos()">Productos</div>
        <div class="input-group-addon btn" ng-click="gestion()">Gestionar</div>
	</div>
	</div>
    ...
    <div ng-show="comenzar_gestion" class="gestion">
        ...
        <div class="margen-top">
        <label class="btn btn-left boton-s" style="background:{{color}}">Sub estado</label><select type="text" ng-model="gestion.sub_estado" ng-options="sub_estado as sub_estado.sub_estado for sub_estado in data.sub_estados" ng-init="gestion.sub_estado = data.sub_estados[0]" class="btn btn-right input-s"></select>
        </div>
    ...
    <table class="table table-condensed" ng-repeat="banco in data.productos | groupBy: 'banco'">
      ...
      <tr ng-repeat="producto in banco" class="table-body producto" ng-click="seleccionar(producto.numero_operacion)" id="{{producto.numero_operacion}}">
        ...
        <td ng-if="producto.dolar==0">${{producto.deuda}}</td><td ng-if="producto.dolar==1">US${{producto.deuda}}</td>
    ...
    <div>
      ...
      <div>
        <label class="btn btn-left boton-c">Deuda</label><label class="btn btn-center symbol" ng-if="data.producto.dolar==0">$</label><label class="btn btn-center symbol" ng-if="data.producto.dolar==1">US$</label><input class="btn btn-right input-c" ng-model="data.producto.deuda=data.producto.deuda">
    </div>
    ...
    <div>
        <label class="btn btn-left boton-s">Email</label><input class="btn btn-center" style="width:35%;text-align:left;" ng-model="data.deudor.email"><label class="btn btn-right" style="width:20%" ng-click="modificar()">Modificar</label>
    </div>
    ...
    <div>
      ...
      <div class="grupo" style="margin-top:15px;">
        ...
        <div class="margen-top">
          <label class="btn btn-primary btn-down" ng-click="data.agregar_telefono()">Agregar</label>
        </div>
      </div>
